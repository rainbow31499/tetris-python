# Version 1.1: Add a progress bar for each level
...
while running:
        ...
        if event.type == QUIT:
            ...
            if event.key == K_SPACE:
                if game_running == False:
                    ...
                    next_block = Block(blocks=tetris_blocks[block_number][0], center_of_rotation=tetris_blocks[block_number][1])
    ...
    pygame.draw.rect(screen, (0,0,0), pygame.Rect(15,105,320,5))
    pygame.draw.rect(screen, (255,0,0), pygame.Rect(16,106,318*(1-lines_to_clear/level_lines),3))

    if combo >= 2:
        score_text = font.render("COMBO " + str(combo), True, (255,0,0))
        screen.blit(score_text, (175,45))
